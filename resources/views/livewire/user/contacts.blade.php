    ...
    <div
        ...
        <div
            ...
            <x-icts.list type="ul" class="list-outside mx-4 text-sm">
                <li>
                    Deze pagina wordt gebruikt voor het beheren van de <b>contacten</b>.
                </li>
                <li>
                    Druk op
                    <b>NIEUW CONTACT</b>
                    om een contact <b>toe te voegen</b>.
                </li>
                <li>
                    Druk op het
                    <x-phosphor-pencil-line-duotone class="inline-block w-5 h-5"/>
                    icoon om een contact te <b>bewerken</b>.
                </li>
                <li>
                    Druk op het
                    <x-phosphor-trash-duotone class="inline-block w-5 h-5"/>
                    icoon om een contact te <b>verwijderen</b>.
                </li>
            </x-icts.list>
        </div>
    </div>
